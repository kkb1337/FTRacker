# FTracker v1.8.30 — Dynamic Index Audit Corrections

- Версия синхронизирована во всех release-метаданных, `index.html`, `app.js`, `manifest.json`, `sw.js` и отображении приложения: **v1.8.30 от 19.09.26**.
- Service Worker и cache переведены на `1.8.30`.
